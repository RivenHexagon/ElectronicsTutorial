...
The only thing left in the causality chain of our electrical circuit is the propper equivalent for the displacement of the water molecules by the pump. In the pump/pressure model we also can identify a source as a place where the flow is directed against the pressure drop. We could almost imagine the water flowing uphill.
